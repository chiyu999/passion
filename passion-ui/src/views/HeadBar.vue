  ...
  <div class="headbar" :style="{'background':themeColor}"
    ...
    <span class="navbar">
      <el-menu :default-active="activeIndex" class="el-menu-demo"
        ...
        <el-menu-item index="2" @click="openWindow('https://github.com/chiyu999/passion/')">{{$t("common.doc")}}</el-menu-item>
        <el-menu-item index="3" @click="openWindow('https://blog.csdn.net/weixin_71614127/')">{{$t("common.blog")}}</el-menu-item>
      </el-menu>
    </span>
    <!-- 工具栏 -->
    <span class="toolbar">
